...
#define IR_PLACEMENT_WIDTH_MM 55

#define ENCODER_NUM_LINES_ROTATION 4096
#define EXTERNAL_GEAR_RATIO  0.25
#define WHEEL_CIRCUMFERENCE_MM 125.664
#define MM_TRAVELED_PER_ROTATION 31.416
